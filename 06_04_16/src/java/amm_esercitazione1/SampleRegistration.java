 ...
 * @author studente
 */
@WebServlet(name = "SampleRegistration", urlPatterns = {"/simpleregistration.html"})
public class SampleRegistration extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (request.getParameter("registra") != null) {
            ...
            String voto = "";
            if(Integer.parseInt(request.getParameter("Voto")) > 0)
...
try (PrintWriter out = response.getWriter()) {
            ...
            out.println("    <textarea name=\"Note\" id=\"Note\" ></textarea>");
            out.println("</div>");
